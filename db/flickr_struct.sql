...
CREATE TABLE `photo` (
  ...
  `flickr_make` varchar(1000) DEFAULT NULL,
  `flickr_model` varchar(1000) DEFAULT NULL,
  ...
  `iso_speed` varchar(255) DEFAULT NULL,
  `upload_date` int(255) DEFAULT '0',
...
CREATE TABLE `user` (
  ...
  `is_done` tinyint(1) NOT NULL DEFAULT '0',
  `is_downloaded` tinyint(1) NOT NULL DEFAULT '0',
  `is_sign_done` tinyint(1) NOT NULL DEFAULT '0',
  `is_fp_done` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`user_id`),
